...
Reference commit before the bounded final fix wave: `886b22a87ea99ce37917d2124807f355506b1c47`
...
- Local SQLite/dashboard failure disables mutation and shows a localized secondary retry action;
  a successful retry clears the error. Definite repeat failure has separate actionable EN/TH copy.
...
- Focused Momentum Home after the final fix wave: **58 passed, 0 failed, 0 skipped** (4 seconds, exit 0).
- Full Mobile regression after the final fix wave: **587 passed, 0 failed, 0 skipped** (7 seconds, exit 0).
