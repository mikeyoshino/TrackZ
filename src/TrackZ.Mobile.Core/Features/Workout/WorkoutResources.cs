...
public sealed record WorkoutTextSet(
    ...
    string EffortInlineLabel,
    string PainInlineLabel,
    string EffortDragPrompt,
    string EffortComfortable,
    string EffortGood,
    string EffortHard,
    string EffortBarelyManageable,
    string EffortEasyEndpoint,
    string EffortBarelyEndpoint,
    string EffortClear,
    string GuidanceSafetyQualifier,
    string EffortSaving,
...
public static class WorkoutResources
{
    ...
    public static WorkoutTextSet ForCulture(CultureInfo culture)
    {
        ...
        return new WorkoutTextSet(
            ...
            Value("EffortInlineLabel", culture),
            Value("PainInlineLabel", culture),
            Value("EffortDragPrompt", culture),
            Value("EffortComfortable", culture),
            Value("EffortGood", culture),
            Value("EffortHard", culture),
            Value("EffortBarelyManageable", culture),
            Value("EffortEasyEndpoint", culture),
            Value("EffortBarelyEndpoint", culture),
            Value("EffortClear", culture),
            Value("GuidanceSafetyQualifier", culture),
