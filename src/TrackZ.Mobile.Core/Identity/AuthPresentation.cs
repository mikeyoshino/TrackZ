    ...
    string InvalidEmail)
{
    public static AuthTextSet English { get; } = new(
        ...
        "Use a password that meets the requirements.", "Can't connect. Check your internet connection and try again.",
    ...
    public static AuthTextSet Thai { get; } = new(
        ...
        "เชื่อมต่อไม่ได้ โปรดตรวจสอบอินเทอร์เน็ตแล้วลองอีกครั้ง", "เข้าสู่ระบบไม่ได้ในขณะนี้ โปรดลองอีกครั้ง",
