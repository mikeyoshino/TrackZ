...
namespace TrackZ.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815155510_AddWorkouts")]
            ...
            modelBuilder.Entity("TrackZ.Domain.Workouts.SetEntry", b =>
                {
                    ...
                    b.ToTable("set_entries", null, t =>
                        {
                            t.HasCheckConstraint("CK_set_entries_measurement", "(\"WeightKg\" > 0 AND \"AssistedKg\" IS NULL) OR (\"WeightKg\" IS NULL AND (\"AssistedKg\" IS NULL OR \"AssistedKg\" > 0))");
