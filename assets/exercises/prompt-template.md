...
| Push-Up | floor | hands shoulder-width, feet together, rigid body | chest lowers between hands then presses away from floor | pectoralis major | hips sagging or elbows flaring straight outward |
| Chest Dip | parallel dip bars | pronated grip, torso leaning forward, knees bent | elbows flex as chest lowers between bars then arms press to support | lower pectoralis major | torso becoming upright and shifting load entirely to triceps |
| Decline Barbell Bench Press | decline bench, barbell | pronated shoulder-width grip, feet secured | bar lowers to lower chest then presses vertically | lower pectoralis major | bar drifting toward neck or shoulders lifting from bench |
| Smith Machine Bench Press | Smith machine, flat bench | pronated shoulder-width grip, feet planted | guided bar lowers to mid-chest then presses vertically | pectoralis major | bench positioned so the fixed bar path reaches the neck |
| Dumbbell Fly | flat bench, two dumbbells | neutral grip, feet planted, elbows softly bent | arms open in a wide arc then sweep together above chest | pectoralis major | bending elbows until the movement becomes a press |
| Low-to-High Cable Fly | dual low cable station | split stance, palms facing upward and inward, soft elbows | handles sweep upward and inward toward upper chest | upper pectoralis major | shrugging shoulders or turning the movement into a front raise |
| High-to-Low Cable Fly | dual high cable station | split stance, palms facing downward and inward, soft elbows | handles sweep downward and inward toward lower chest | lower pectoralis major | bending at the waist instead of moving the arms through an arc |
